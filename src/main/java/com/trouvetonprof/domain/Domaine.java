...
public class Domaine implements Serializable {
	...
	@OneToMany(mappedBy = "domaine")
	@Cache(usage = CacheConcurrencyStrategy.NONSTRICT_READ_WRITE)
	private Set<Annonce> annonce = new HashSet<>();
	...
	public Domaine annonce(Set<Annonce> annonce) {
		this.annonce = annonce;
		return this;
	}

	public Domaine addAnnonce(Annonce annonce) {
		this.annonce.add(annonce);
		annonce.setDomaine(this);
		return this;
	}

	public Domaine removeAnnonce(Annonce annonce) {
		this.annonce.remove(annonce);
