...
import { IAnnonce, Annonce, Satut } from 'app/shared/model/annonce.model';
...
describe('Service Tests', () => {
    describe('Annonce Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new Annonce(0, 'AAAAAAA', 'AAAAAAA', Satut.PROFESSEUR, 'image/png', 'AAAAAAA', false, 0);
        });
