...
CREATE TABLE `disponibilite` (
  ...
  PRIMARY KEY (`id`),
  KEY `fk_disponibilite_annonce_id` (`annonce_id`),
  CONSTRAINT `fk_disponibilite_annonce_id` FOREIGN KEY (`annonce_id`) REFERENCES `annonce` (`id`)
...
INSERT INTO `disponibilite` VALUES (1,'2019-03-11 10:00:00',5,1),(2,'2019-03-11 22:00:00',2,1),(3,'2019-03-13 09:00:00',2,1);
